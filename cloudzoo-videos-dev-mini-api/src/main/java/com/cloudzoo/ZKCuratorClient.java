...
import com.cloudzoo.cofig.ResourceConfig;
import com.cloudzoo.enums.BGMOperatorTypeEnum;
import com.cloudzoo.utils.JsonUtils;
...
//	public static final String ZOOKEEPER_SERVER = "192.168.205.130:2181";
	...
	public void init() {
		...
		try {
//			String testNodeData = new String(client.getData().forPath("/bgm/190313FZN98MX9WH"));
...
//					String songPath = bgm.getPath();
					...
					// 2. 定义保存到本地的bgm路径
//					String filePath = "C:\\cloudzoo_videos_dev" + songPath;
...
//					String bgmUrl = "http://192.168.205.134:8080/mvc" + finalPath;
